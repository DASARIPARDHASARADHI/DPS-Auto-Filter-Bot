...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002120306118').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dasaripardhasaradhi143:vFeD8aXQTWNbdg4c@cluster0.u0jnzit.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002022530839'))
...
URL = "https://demo-dzbo.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demo-dzbo.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-dzbo.onrender.com/".format(FQDN)
else:
    URL = "https://demo-dzbo.onrender.com/".format(FQDN)
